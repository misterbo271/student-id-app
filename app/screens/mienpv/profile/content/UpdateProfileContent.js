...
const FormikInput = ({initialValues, onUpdate}) => {
...
const UpdateProfileContent = ({defaultParam, onUpdate}) => {
        ...
        <CBContainer>
            <CBView style={{flex: 1, paddingHorizontal: 30}} define={'none'}>
                ...
                <CBScrollView
                    ...
                    define={'content'}>
                    <FormikInput initialValues={{id: studentInfo?._id, fullName: studentInfo?.name, phoneNumber: studentInfo?.phone_number, address: studentInfo?.address, email: studentInfo?.email, birthday: studentInfo?.day_of_birth}} onUpdate={onUpdate}/>
                </CBScrollView>
